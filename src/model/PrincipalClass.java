...
public class PrincipalClass {
	...
	public PrincipalClass(String r) {
		...
		loadMap();
		System.out.println(loadStoryLine());
	...
	public String loadStoryLine() {
		//manejar mensajes del arbol story en el juego: timer, pasar lvl
		String show="";
		try {
			...
			while(line!=null) {
				a++;
				char c = (char)(Integer.parseInt(line,2));
